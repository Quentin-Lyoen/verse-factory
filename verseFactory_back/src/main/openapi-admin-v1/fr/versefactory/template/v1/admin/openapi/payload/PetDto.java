...
public class PetDto implements Serializable {
   ...
   */
  public PetDto(UUID id, String name, String rarity) {
    this.id = id;
    this.name = name;
    this.rarity = rarity;
  }
  ...
  public PetDto rarity(String rarity) {
    this.rarity = rarity;
    return this;
  }
  ...
  public PetDto incomePerSecond(BigDecimal incomePerSecond) {
  ...
  public PetDto baseCost(BigDecimal baseCost) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, petDto.id) &&
        ...
        Objects.equals(this.rarity, petDto.rarity) &&
        Objects.equals(this.incomePerSecond, petDto.incomePerSecond) &&
        Objects.equals(this.baseCost, petDto.baseCost);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, rarity, incomePerSecond, baseCost);
  }
