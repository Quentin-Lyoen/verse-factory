...
public class Example extends TableImpl<ExampleRecord> {
    ...
    /**
     * The reference instance of <code>versefactory.example</code>
     */
    ...
    /**
     * The column <code>versefactory.example.id</code>.
     */
    ...
    /**
     * The column <code>versefactory.example.name</code>.
     */
    public final TableField<ExampleRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>versefactory.example</code> table reference
     */
    ...
    /**
     * Create a <code>versefactory.example</code> table reference
     */
    public Example() {
